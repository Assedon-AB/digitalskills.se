...
const Home: NextPage = () => {
  return (
    ...
    <main className="max-w-6xl mx-auto px-4 min-h-screen pt-16">
      ...
      <p className="mb-4 leading-relaxed tracking-wide">Vill du i detalj veta hur digitalskills.se är framtaget så hittar du <a href="https://github.com/orgs/Assedon-AB" rel="noreferrer" target="_blank" className="text-blue-600 hover:text-blue-900 underline">koden till verktyget här.</a></p>
