  ...
  return (
    ...
    <main className="max-w-6xl mx-auto px-4 min-h-screen pt-16">
      ...
      <p className="mb-4 leading-relaxed tracking-wide">
          <a className="text-blue-600 hover:text-blue-900 hover:underline" target="_blank" rel="noreferrer" href="https://tillvaxtverket.se/">Tillväxtverket</a> och <a className="text-blue-600 hover:text-blue-900 hover:underline" target="_blank" rel="noreferrer" href="https://www.uka.se/">Universitetskanslersämbetet</a> har av regeringen fått i uppdrag att tillsammans analysera och föreslå hur kompetensförsörjningen av digital spetskompetens kan utvecklas både kort- och långsiktigt. Projektet ska starta en dialog om samverkan mellan berörda aktörer, i syfte att öka tillgången på digital spetskompetens. I uppdraget ingår också att så långt det är möjligt säkerställa en förbättrad tillgång till statistik och prognoser över efterfrågan och tillgången på digital spetskompetens på svensk arbetsmarknad. Uppdraget ska slutredovisas till Regeringskansliet senast den 31 oktober 2022. Du kan läsa mer om uppdraget här: <a className="text-blue-600 hover:text-blue-900 hover:underline" target="_blank" rel="noreferrer" href="https://digitalspetskompetens.se/om/">https://digitalspetskompetens.se/om/</a>
      </p>
