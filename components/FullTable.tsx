...
interface FullTableProps {
	...
	updateCompareList: (arg: any) => void;
	compareList: string[];
	showModal: () => void;
}
				...
				<div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
								...
								<tr>
									...
									>
										<div className="flex items-center">
											...
											<InfoPopover
												isSmall={true}
												title="Vad betyder trend?"
												text="Trenden räknas fram genom att jämföra senast uppmätta månadsvärde historiskt över trendperioderna."
											/>
										</div>
									</th>
									<th
									...
									>
										<div className="flex items-center">
											...
											<InfoPopover
												isSmall={true}
												title="Vad betyder prognos?"
												text="Prognosen görs med hjälp av exponentiell utjämning över prognosperioderna framåt sett från senast uppmätta månadsvärde."
											/>
										</div>
									</th>
									<th scope="col"></th>
									<th
										scope="col"
										className="px-6 py-3 text-center bg-gray-100 font-medium text-gray-800 uppercase tracking-wider"
									>
										<p className="text-[10px]">Jämför</p>
									</th>
								</tr>
								<tr>
									<th
									...
									>
										<button
											className="flex flex-row hover:text-blue-800"
											onClick={() => setSortMode("Namn")}
										>
									...
									>
										<div className="flex items-center">
											<button
												onClick={() =>
													setSortMode("Alla annonser")
												}
												className={`flex items-center flex-row hover:text-blue-800 ${
											...
											<InfoPopover
												isSmall={true}
												title="Vad betyder annonser?"
												text="Annonser är antalet annonser uppmätta den senaste månaden i datan."
											/>
										</div>
									</th>
									...
									>
										<button
											...
											className="flex flex-row underline hover:text-blue-800"
										>
											Rensa{" "}
											<span className="sr-only">
												valda {category}
									...
									>
										<span
											className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
												industry.trend_percentages
													.month_6 > 0
													? "bg-green-100 text-green-800"
													: "bg-red-100 text-red-800"
											}`}
										>
											{industry.trend_percentages.month_6.toFixed(
												1
											)}{" "}
											%
										</span>
                    ...
                    uppercase tracking-wider bg-[#3A8DDE]/25`}
									>
										...
										>
											{industry.trend_percentages.month_12.toFixed(
												1
											)}{" "}
											%
										</span>
                    ...
                    uppercase tracking-wider bg-[#3A8DDE]/25`}
									>
										...
										>
											{industry.trend_percentages.month_18.toFixed(
												1
											)}{" "}
											%
										</span>
                    ...
                    uppercase tracking-wider bg-[#3A8DDE]/25`}
									>
										<span
											className={`px-2 inline-flex  text-xs leading-5 font-semibold rounded-full ${
												industry.prediction_percentages
													.month_6 > 0
													? "bg-green-100 text-green-800"
													: "bg-red-100 text-red-800"
											}`}
										>
											{industry.prediction_percentages.month_6.toFixed(
												1
											)}{" "}
											%
										</span>
                    ...
                    uppercase tracking-wider bg-[#3A8DDE]/25`}
									>
										...
										>
											{industry.prediction_percentages.month_12.toFixed(
												1
											)}{" "}
											%
										</span>
                    ...
                    uppercase tracking-wider bg-[#3A8DDE]/25`}
									>
										...
										>
											{industry.prediction_percentages.month_18.toFixed(
												1
											)}{" "}
											%
										</span>
