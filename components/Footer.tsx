...
const Footer = () => {
  return (
    <footer className="bg-[#fafafa] p-8">
        <p className="text-center mb-4">Har du hittat en bugg eller har förslag på förbättringar? <a href="mailto:fred@assedon.se?subject=Bugg eller förslag digitalskills.se" className="underline hover:text-blue-500">Kontakta oss</a></p>
