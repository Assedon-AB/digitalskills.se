...
const Navbar = () => {
	...
	return (
		<nav className="p-4 max-w-6xl mx-auto flex items-center print:hidden">
			<p className="text-2xl block min-w-max"> {"digitalskills.se"}</p>
			<button
          ...
          ${
			...
			>
				<li className="focus:outline-none focus:ring focus:ring-violet-300">
					<Link href="/">
						<a
							tabIndex={0}
				...
				<li className="focus:outline-none focus:ring focus:ring-violet-300 flex-grow">
