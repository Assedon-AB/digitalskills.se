      ...
      <div className="flex items-center justify-between">
        <div className="flex items-start">
          ...
          <div className="flex flex-col ml-3 mr-8">
            <div className="font-medium text-sm leading-none">Välj kompetenser eller yrken att jämföra</div>
            <p className="text-xs text-gray-600 leading-none   mt-1">
            Klicka i de kompetenser eller yrken som du vill jämföra.
            </p>
